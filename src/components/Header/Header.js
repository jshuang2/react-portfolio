                ...
                <div className="container">
                    ...
                    <div className={` collapse navbar-collapse ${this.state.isMenuVisible ? "openMenuArea dropdown-menu dropdown-menu-right" : ""}`} id="navbarNavAltMarkup">
                        <ul className="navbar-nav ml-auto">
                            ...
                            <li className={`nav-item nav-link ${this.state.isMenuVisible ? "openMenu dropdown-item" : "pageLink"}`} ><a href="https://drive.google.com/file/d/1DAGGhumW8PF0pAbcw1lMF1iCq1Vtv4HF/view?usp=sharing" target="_blank" rel="noopener noreferrer">Resume</a>
                            </li>
                        </ul>
